...
from models.ipad_model import IpadItemModel
import datetime
...
class IpadSpider(scrapy.Spider):
    ...
    url = "https://istore.lt/apple-ipad-plansetes"

    custom_settings = {
        'LOG_FILE': 'logs/ipad_logs.log',
        'FEEDS': {
            'data/ipad_output.jsonl' : {
                'format': 'jsonlines',
                'encoding': 'utf8',
                'store_empty': False,
                'overwrite': True
    ...
    def parse(self, response):
        ...
        for product in products:
            ...
            name, params = product_info.split('"', 1)
    ...
    def closed(self, reason):
        print("\n\n--- istore.lt iPad products Crawl Finished ---")
