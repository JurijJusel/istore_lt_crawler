...
.PHONY: venv venv-activate setup all run clean del_venv info help
...
setup:
	@echo "Install dependencies from pyproject.toml and sync with uv.lock"
	$(UV) sync
	$(UV) lock
...
help:
	...
	@echo "  venv-activate	  		- Activate the virtual environment"s
	@echo
